...
Update docs and `README.md` as needed while implementing. Document task status and codebase changes (architecture, implementation details, usage, and workflow impacts). Add new files or subfolders to `/docs` as necessary. `/docs` should be optimized for quality, maintainability and readability.
